enabled = Rearmed::ENABLED[:rails_4] == true

if enabled || Rearmed.dig(Rearmed::ENABLED, :rails_4, :link_to_confirm) == true
...
ActiveRecord::Batches.module_eval do
  if enabled || Rearmed.dig(Rearmed::ENABLED, :rails_4, :find_in_relation_batches) == true
  ...
  if enabled || Rearmed.dig(Rearmed::ENABLED, :rails_4, :find_relation_each) == true
...
if enabled || Rearmed.dig(Rearmed::ENABLED, :rails_4, :or) == true
  module ActiveRecord
    module Querying
      delegate :or, :to => :all
    end
